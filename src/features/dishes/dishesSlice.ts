...
const templateDishes: Dish[] = [
  { name: 'Овсянка', type: 'Завтрак', ingredients: [
    { n: 'овсяные хлопья', q: 50, u: 'г' },
    { n: 'молоко', q: 200, u: 'мл' },
    { n: 'яблоко', q: 0.5, u: 'шт' },
    { n: 'мёд', q: 1, u: 'ст.л.' },
  ]},
  { name: 'Омлет с овощами', type: 'Завтрак', ingredients: [
    { n: 'яйца', q: 2, u: 'шт' },
    { n: 'молоко', q: 30, u: 'мл' },
  ...
  { name: 'Суп чечевичный', type: 'Обед', ingredients: [
    { n: 'чечевица', q: 80, u: 'г' },
  ...
  { name: 'Курица с рисом', type: 'Ужин', ingredients: [
    { n: 'куриная грудка', q: 150, u: 'г' },
    { n: 'рис', q: 70, u: 'г' },
    { n: 'масло растительное', q: 1, u: 'ст.л.' },
    { n: 'специи', q: 1, u: 'щепотка' },
  ]},
  { name: 'Паста с овощами', type: 'Обед', ingredients: [
  ...
  { name: 'Рыба запечённая', type: 'Ужин', ingredients: [
    { n: 'филе рыбы', q: 160, u: 'г' },
    { n: 'лимон', q: 0.25, u: 'шт' },
    { n: 'масло оливковое', q: 1, u: 'ст.л.' },
    { n: 'соль', q: 1, u: 'щепотка' },
  ]},
  { name: 'Салат греческий', type: 'Любое', ingredients: [
    { n: 'огурец', q: 0.5, u: 'шт' },
    { n: 'помидор', q: 1, u: 'шт' },
    { n: 'перец сладкий', q: 0.25, u: 'шт' },
    { n: 'фета', q: 60, u: 'г' },
  ...
  { name: 'Борщ быстрый', type: 'Обед', ingredients: [
    { n: 'свекла', q: 0.5, u: 'шт' },
    { n: 'капуста', q: 150, u: 'г' },
    { n: 'морковь', q: 0.5, u: 'шт' },
    { n: 'лук', q: 0.5, u: 'шт' },
  ...
  { name: 'Лосось с булгуром', type: 'Ужин', ingredients: [
    { n: 'лосось', q: 170, u: 'г' },
    { n: 'булгур', q: 70, u: 'г' },
    { n: 'лимон', q: 0.25, u: 'шт' },
    { n: 'оливковое масло', q: 1, u: 'ст.л.' },
  ]},
  { name: 'Сэндвич с индейкой', type: 'Любое', ingredients: [
    { n: 'хлеб', q: 2, u: 'ломт' },
